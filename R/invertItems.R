...
#' @param item The vector to invert.
...
#' @param fullRange The full range; will otherwise be derived from the vector.
#' @param ignorePreviousInversion Whether to avoid inverting items that were
#' already inverted.
