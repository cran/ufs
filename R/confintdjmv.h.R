...
confintdjmvOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "confintdjmvOptions",
...
confintdjmvResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
confintdjmvBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "confintdjmvBase",
